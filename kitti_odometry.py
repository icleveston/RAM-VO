...
class KittiEvalOdom():
    ...
    def eval(self, gt_dir, 
        ...
        poses_result = self.load_poses_from_txt('out/'+gt_dir+"/prediction.txt")
        poses_gt = self.load_poses_from_txt('out/'+gt_dir + "/groundtruth_kitti.txt")
        self.result_file_name = result_dir
        ...
        self.save_sequence_errors(seq_err, error_dir + "/" + 'err')
        ...
        # Plotting
        self.plot_trajectory(poses_gt, poses_result, 0)
        self.plot_error(avg_segment_errs, 0)

        return ave_t_err*100, ave_r_err/np.pi*180*100, ate, rpe_trans, rpe_rot
