...
class PixelSkippedDataset(Dataset):

    def __init__(self, trans):
           
        self.trans = trans
           
        data_dir = 'dataset/pixel_skipped/00/'
    ...
    def __getitem__(self, idx):
        ...
        displacement = torch.tensor([x_t_1-x_t, y_t_1-y_t])
            
        return images, displacement
...
class PixelUniformDataset(Dataset):
    ...
    def __init__(self, trans):
        ...
        data_dir = 'dataset/pixel_uniform/00/'
