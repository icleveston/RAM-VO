...
def main(data_dir, minibatch, save):
    ...
    for i in range(1, count_files+1):
        ...
        # Unpack the losses
            train_mse, train_mae, train_reward, train_loss_action, train_loss_baseline, train_loss_reinforce, _ = train_loss
            val_mse, val_mae, val_reward, val_loss_action, val_loss_baseline, val_loss_reinforce, _ = val_loss
        else:
            train_mse, train_mae, train_reward, train_loss_action, train_loss_baseline, train_loss_reinforce = train_loss
            val_mse, val_mae, val_reward, val_loss_action, val_loss_baseline, val_loss_reinforce = val_loss
    ...
    titles = ['MSE', 'MAE', 'Reward', 'All Losses', 'Reinforce Loss', 'Baseline Loss (MSE)']
