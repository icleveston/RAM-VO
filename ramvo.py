...
class RAMVO(nn.Module):
    ...
    def forward(self, x):
        ...
        self.core.hidden_cell = (torch.stack((h_t_0, h_t_1)), torch.zeros(2, self.batch_size, 1024).to(self.device))
...
class BaselineNetwork(nn.Module):
    ...
    def forward(self, h_t):
        ...
        b_t = torch.tanh(self.fc_1(h_t.detach()))
