...
class Main:
    ...
    def __init__(self):
        ...
        self.memory = Memory()
        self.ppo = PPO(state_dim=1024, action_dim=2, action_std=0.2, lr=0.00001, betas=(0.9, 0.999), gamma=0.99, K_epochs=20, eps_clip=0.2)
    ...
    def _train_one_epoch(self, epoch):
        ...
        with tqdm(total=self.num_train) as pbar:
            ...
            for i, (x, y) in enumerate(self.train_loader):
                ...
                self.model.core.hidden_cell = (torch.stack((h_t_0, h_t_1)), torch.zeros(2, self.batch_size, 1024).to(self.device))
