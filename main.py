...
class Main:
    ...
    def __init__(self):
        ...
        self.optimizer = torch.optim.Adam([
                ...
                {'params': self.model.locator.parameters(), 'lr': 1e-6},
    ...
    def _train_one_epoch(self, epoch):
        ...
        with tqdm(total=self.num_train) as pbar:
            ...
            for i, (x, y) in enumerate(self.train_loader):
                ...
                predicted, l_t_array, log_pi_array, baseline_array, entropy_array = self.model(x)
    ...
    def _validate(self, epoch):
        ...
        for i, (x, y) in enumerate(self.valid_loader):
            ...
            predicted, l_t_array, log_pi_array, baseline_array, _ = self.model(x)
    ...
    @torch.no_grad()
    def test(self, model_name, dataset, test_seq, save_trajectory=True):
        ...
        images_all = torch.tensor([]).to('cpu')
        ...
        for i, (x, y) in enumerate(self.test_loader):
            ...
            predicted, l_t_array, _, _, _ = self.model(x)
            ...
            images_all = torch.cat((images_all, x[:, 0].cpu()), axis=0)
        ...
        if save_trajectory:
            ...
            glimpses_full = [images_all.cpu(), l_t_array_all.cpu()]
            
            # Dump the glimpses
            with open(os.path.join(self.output_path, f"glimpses_epoch_full.p"), "wb") as f:
                pickle.dump(glimpses_full, f)
