...
class RecurrentAttention(nn.Module):
    ...
    def forward(self, x_0, x_1, l_t, h_state):
...
class GlimpseNetwork(nn.Module):
    ...
    def __init__(self, patch_size, num_patches, glimpse_scale):
        ...
        # Image layers
        self.conv_1_1 = nn.Conv2d(1, 4, kernel_size=5, padding=1)
        self.conv_1_2 = nn.Conv2d(4, 8, kernel_size=5, padding=1)
        
        self.conv_2_1 = nn.Conv2d(1, 4, kernel_size=5, padding=1)
        self.conv_2_2 = nn.Conv2d(4, 8, kernel_size=5, padding=1)
        
        self.conv_3_1 = nn.Conv2d(1, 4, kernel_size=5, padding=1)
        self.conv_3_2 = nn.Conv2d(4, 8, kernel_size=5, padding=1)
        
        self.fc_x_1 = nn.Linear(1352, 64)
        self.fc_x_2 = nn.Linear(1352, 32)
        self.fc_x_3 = nn.Linear(1352, 32)
