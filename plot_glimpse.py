...
def main(plot_dir, epoch, save_as_gif):
    ...
    def updateData(i):
        ...
        if i % interval_frames == 0:
            ...
            # Set the plot title
            glimpse_0.set_title('Sensor 0 - c: '+ str(glimpse_center_0) + " catch:" + str(catch_0[input_index]), {'fontsize': 10, 'verticalalignment': 'top'}, y=1, loc='center')
            glimpse_1.set_title('Sensor 1 - c: '+ str(glimpse_center_1) + " catch:" + str(catch_1[input_index]), {'fontsize': 10, 'verticalalignment': 'top'}, y=1, loc='center')
